...
export default function Page() {
  return (
    <div className="min-h-screen flex flex-col items-center bg-gradient-to-r from-indigo-600 to-blue-500 text-white animate-gradient">
      ...
      <section className="w-full max-w-4xl px-4 sm:px-6 lg:px-8 mb-16">
        <div className="bg-gray-800 p-8 rounded-lg shadow-lg mb-8 animate-slideInFromLeft transform transition-transform duration-300 hover:scale-105">
        ...
        <div className="bg-gray-800 p-8 rounded-lg shadow-lg mb-8 animate-slideInFromRight transform transition-transform duration-300 hover:scale-105">
        ...
        <div className="bg-gray-800 p-8 rounded-lg shadow-lg animate-slideInFromBottom transform transition-transform duration-300 hover:scale-105">
